...
const PROJECTS = [
  {
    ...
    textColor: 'white',
    description: 'Разработали продающий лендинг для автосервиса в Серпухове. Упор на онлайн-запись и доверие: реальные мастера, гарантии, прозрачные цены.',
    done: [
      'Разработка лендинга с нуля',
      'Онлайн-форма записи с уведомлением',
  ...
  },
  {
    ...
    textColor: '#1A1A1A',
    description: 'Премиальный лендинг для стоматологии. Минималистичный дизайн уровня европейских клиник. Акцент на доверие, врачей и бесплатный первичный осмотр.',
    done: [
  ...
  },
  {
    ...
    textColor: 'white',
    description: 'Архитектурный лендинг для компании натяжных потолков. Стиль премиум-студии, интерактивный калькулятор стоимости.',
    done: [
  ...
  },
  {
    ...
    textColor: 'white',
    description: 'Современный лендинг клининговой компании с анимациями которых нет у конкурентов. Canvas пузырьки, живой счётчик, степ-калькулятор.',
    done: [
      'Canvas анимация пузырьков в hero',
      'Живой счётчик выполненных уборок',
      'Калькулятор стоимости 3 шага',
      '3D flip карточки услуг',
      'Анимированный трек после заявки',
    ],
  ...
  },
  {
    ...
    textColor: 'white',
    description: 'Брутальный лендинг логистической компании. Стиль между DHL и премиум-сервисом. Калькулятор стоимости с выбором авто и грузчиков.',
    done: [
  ...
  },
  {
    ...
    textColor: 'white',
    description: 'Тёмный брутальный лендинг барбершопа. Peaky Blinders meets NYC barbershop. Онлайн-запись к конкретному мастеру, аккордеон услуг.',
    done: [
  ...
  },
  {
    ...
    textColor: 'white',
    description: 'Продвижение автосервиса на Авито. Упаковали профиль, написали продающие объявления, настроили платное продвижение.',
    done: [
      'Полная упаковка профиля на Авито',
      '10 продающих объявлений с фото',
      'Настройка платного продвижения',
      'Оформление Яндекс Карт',
  ...
  {
    id: 9,
    title: 'TG Bot автозапись',
    type: 'Кейс · Автоматизация',
    category: 'auto',
    gradient: 'linear-gradient(135deg, #0F2027, #203A43)',
    textColor: 'white',
    description: 'Telegram-бот для онлайн-записи к косметологу. Принимает заявки, отправляет напоминания, ведёт запись в таблицу.',
    done: [
    ...
    stats: { time: '7 дней', conversion: 'Авто 100%', leads: '−3ч/день' },
  ...
  },
  {
    ...
    description: `Стоматология в Серпухове была на 8-й странице Яндекс Карт — клиенты просто не доходили до неё. Полностью переупаковали карточку: фото, описание, услуги, цены, ответы на отзывы. Подключили платное продвижение. Через 2 недели клиника вошла в ТОП-3 по запросу "стоматология Серпухов".`,
    done: [
      'Полное заполнение карточки организации',
      'Загрузка 40+ профессиональных фото',
      'Прописали все услуги с ценами',
      'Ответили на все старые отзывы',
      'Стратегия получения новых отзывов',
      'Подключение платного продвижения',
      'Еженедельный мониторинг позиций',
    ],
    results: [
    ...
    quoteAuthor: 'Администратор Dental Club',
    ...
    <div style={{ breakInside: 'avoid', marginBottom: '16px' }}>
      <motion.div
        ...
        style={{
          ...
          borderColor: hovered ? '#6366F1' : '#1E1E1E',
        }}
      >
        {/* Preview */}
