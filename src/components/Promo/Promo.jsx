...
export default function Promo() {
  ...
  const PAINS = [
    'Хочется новых клиентов и роста выручки — но обычная реклама не приводит. А расти на одном сарафане сложно',
    'Карточка в Яндекс.Картах есть, но давно не обновлялась — фото старые, услуг с ценами нет, истории не публикуются. Платная подписка работает впустую',
    'Сайта нет вообще, или есть, но устаревший. Клиент заходит и сразу закрывает',
    'Отзывы появляются медленно, негативные не отрабатываются. Конкурентов в Серпухове много — клиент сравнивает напрямую',
    'Заниматься онлайн-присутствием некому. Все силы уходят на основную работу — а маркетинг остаётся на потом',
  ]
  ...
  const MAPS_LIST = [
    ...
    'Ставлю систему получения реальных отзывов от клиентов (QR-коды, скрипты сотрудникам)',
    'Повышаю рейтинг компании',
    'Веду стабильный контент-план: истории, акции, новости компании',
    'Слежу за актуальностью: фото, цены, часы работы',
  ]

  const SITE_LIST = [
    'Делаю аккуратный, презентабельный сайт под ваш бизнес',
    'Наполняю контентом: блоки услуг, прайс, акции, контакты',
    'Формирую необходимый контент, если у вас его недостаточно. Прорабатываем блоки услуг и описания',
  ...
  const PROCESS = [
    { num: '01', title: 'Знакомство', time: '15 минут', items: ['Звонок или встреча у вас в офисе/на точке', 'Я уже изучил вашу компанию онлайн — приду с конкретным планом', 'Вы решаете брать или нет — без давления'] },
  ...
  const FAQS = [
    { q: 'Почему так дёшево? Сколько стоят такие услуги в Москве?', a: 'В Москве сайт — от 80–150 тыс., ведение Карт — от 30 тыс./мес. Я работаю в Серпухове, без офиса и команды менеджеров — поэтому цены ниже. Качество от этого не страдает.' },
    { q: 'Я уже работал с маркетологами и ничего не получилось.', a: 'Понимаю, такое часто бывает с агентствами на удалёнке. Я работаю иначе: приезжаю лично, разбираюсь в вашей ситуации, отвечаю за результат. Если за 2 месяца карточка не вырастет — вернётесь к прежней схеме без потерь.' },
    { q: 'Не хочу заниматься этим — нет времени.', a: 'Это и есть моя задача. После запуска беру всё на себя — обновление карточки, ответы на отзывы, актуальные акции, контент-план. Ваше участие — раз в месяц 15 минут на согласование плана.' },
    { q: 'Что если придут негативные отзывы?', a: 'Это нормальная часть работы. Грамотный ответ на негатив часто работает на репутацию лучше, чем десять положительных. Знаю как отвечать, чтобы рейтинг не падал, а часть негативных удаляется через службу поддержки Яндекса.' },
        ...
        <div className="dp-container" style={{ position: 'relative', zIndex: 1, padding: '80px 6% 60px' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <p style={{
              ...
              Серпухов · Маркетинг для малого бизнеса
            </p>
          </motion.div>
        ...
        <div className="dp-container">
          <Reveal>
            ...
            <h2 className="dp-h2" style={{ marginBottom: '48px' }}>
              Что происходит на рынке<br />
              <span style={{ color: '#6366F1' }}>Серпухова прямо сейчас</span>
            </h2>
          </Reveal>
            ...
            {[
              {
                ...
                desc: 'Карточка в Яндексе, отзывы, сайт — всё это смотрят до того как позвонить или прийти.',
                color: '#6366F1',
              },
              {
                num: 'от 4,7★',
          ...
          <Reveal delay={0.3}>
            <div style={{
              ...
              <p style={{
                ...
                Доверие к бизнесу формируется <span style={{ color: '#6366F1' }}>до первого контакта.</span>
              </p>
            </div>
          </Reveal>
        </div>
          ...
          <div className="dp-two-col">
            ...
            <Reveal delay={0} fullHeight>
              <div className="dp-card" style={{ height: '100%', borderColor: 'rgba(99,102,241,0.3)', display: 'flex', flexDirection: 'column' }}>
                ...
                <button
                  type="button"
                  onClick={() => setLightbox('/promo/ya-dental.png')}
                  style={{
                    aspectRatio: '16/10',
                    background: '#0A0A0F',
                ...
                >
                  <img
                    src="/promo/ya-dental.png"
                    alt="Карточка компании в Яндекс.Картах — Серпухов"
                    loading="lazy"
                    style={{
                ...
                <p style={{
                  ...
                  Это первое, что видит клиент, когда ищет вашу услугу в Серпухове. От рейтинга, фото и отзывов зависит — позвонит он или прокрутит дальше к конкуренту.
                </p>
            ...
            <Reveal delay={0.1} fullHeight>
              <div className="dp-card" style={{ height: '100%', borderColor: 'rgba(6,182,212,0.3)', display: 'flex', flexDirection: 'column' }}>
                ...
                <button
                  type="button"
                  onClick={() => setLightbox('/promo/site_dental.jpg')}
                  style={{
                ...
                >
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '10px', color: '#5A5A6A' }}>example-dental-clinic.ru</span>
                    </div>
                  </div>
                  <div style={{ flex: 1, position: 'relative', background: '#FFFFFF', overflow: 'hidden' }}>
                    <img
                      src="/promo/site_dental.jpg"
                      alt="Сайт компании — пример"
                      loading="lazy"
                ...
                <p style={{
                  ...
                  Сюда попадает клиент после Карт или поиска. Сайт показывает услуги, цены и условия — клиент понимает что вам можно доверять и едет заказывать.
                </p>
      ...
      <section className="dp-section" style={{ background: '#080808' }}>
        <div className="dp-container">
          <Reveal>
            ...
            <h2 className="dp-h2" style={{ color: '#6366F1', marginBottom: '16px' }}>поток новых клиентов.</h2>
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 'clamp(15px, 2vw, 17px)', color: '#A0A0A0', lineHeight: 1.7, maxWidth: '620px', marginBottom: '48px' }}>
              Карточка в Яндекс.Картах и сайт компании работают в связке. Карточка приводит человека, сайт его убеждает.
            </p>
          </Reveal>
            ...
            {[
              {
                ...
                desc: 'Системная работа над ростом позиций по запросам вашей сферы — выводим в топ Яндекса по ключевым запросам "[ваша услуга] серпухов" и связанным',
                price: '25 000 ₽/мес',
              },
              {
                icon: '✨',
                title: 'Дизайнерский сайт на коде',
                desc: 'С анимациями, индивидуальным дизайном. Для премиум-сегмента, желающих выделиться среди конкурентов',
                price: '50 000 ₽',
                old: '73 000 ₽',
              },
              {
                ...
                desc: 'Telegram-бот, правки на сайте, настройка рекламы, настройка телефонии, аналитика, скрипты продаж',
                price: '5 000 ₽/мес',
              },
            ].map((s, i) => (
        ...
        <div className="dp-container" style={{ textAlign: 'center' }}>
          <Reveal>
            ...
            <h2 className="dp-h2" style={{ maxWidth: '720px', margin: '0 auto 20px' }}>
              Привлечём вам новых клиентов{' '}
              <span style={{
                background: 'linear-gradient(135deg, #6366F1, #06B6D4)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
              }}>уже в этом месяце</span>
            </h2>
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: '17px', color: '#A0A0A0', marginBottom: '48px' }}>
              Бесплатная консультация. Без обязательств. После звонка вы решите — нужно вам это или нет.
            </p>
          </Reveal>
