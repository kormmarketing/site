...
// ── Main component ────────────────────────────────────────────────
export default function DentalPromo() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    setFormError('')
    if (!form.name.trim()) { setFormError('Введите название клиники'); return }
    ...
    const text = `🦷 *Заявка со страницы dental-promo2026*\n\n🏥 *Клиника:* ${form.name}\n📱 *Контакт:* ${form.contact}`
    try {
  ...
  const FAQS = [
    { q: 'Почему так дёшево? Сколько стоят такие услуги в Москве?', a: 'В Москве сайт под ключ — от 80-100 тыс., ведение Карт — от 30 тыс./мес. Я работаю в Серпухове, без офиса и команды менеджеров — поэтому цены ниже. Качество от этого не страдает.' },
    ...
    { q: 'Не хочу заниматься этим — нет времени.', a: 'Это и есть моя задача. После запуска беру всё на себя — обновление карточки, ответы на отзывы, актуальные акции. Ваше участие — раз в месяц 15 минут на согласование плана.' },
        ...
        <div className="dp-container" style={{ position: 'relative', zIndex: 1, padding: '80px 6% 60px' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <p style={{
              ...
              Серпухов · Стоматологии · Маркетинг
            </p>
          </motion.div>
          ...
          >
            ...
            <span style={{
              ...
              Сделаем так, чтобы выбирали вас.
            </span>
          </motion.h1>
          ...
          >
            <a href="#cta" className="dp-btn-primary"
              ...
              Получить план работ за 15 минут
            </a>
            <a href={TG} target="_blank" rel="noopener noreferrer"
              style={{
        ...
        <div className="dp-container">
          <Reveal>
            ...
            <h2 className="dp-h2" style={{ marginBottom: '48px' }}>
              Что происходит на рынке стоматологий<br />
          ...
          <div className="dp-stats-grid" ref={statsRef}>
            {[
              {
                num: '9 из 10',
                label: 'пациентов изучают клинику онлайн перед записью',
                desc: 'Карточка в Яндексе, отзывы, сайт — всё это смотрят до того как позвонить.',
                color: '#6366F1',
              },
              {
                num: 'от 4,7★',
              ...
              },
              {
                ...
                desc: 'Если за 8 секунд сайт не вызвал доверия — пациент закрыл вкладку.',
                color: '#06B6D4',
              },
            ].map((s, i) => (
          ...
          <Reveal delay={0.3}>
            <div style={{
              ...
              <p style={{
                ...
                Репутация формируется <span style={{ color: '#6366F1' }}>до первого визита.</span>
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section className="dp-section" style={{ background: '#080808' }}>
        <div className="dp-container">
          <Reveal>
            ...
            <h2 className="dp-h2" style={{ color: '#6366F1', marginBottom: '16px' }}>поток новых пациентов.</h2>
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 'clamp(15px, 2vw, 17px)', color: '#A0A0A0', lineHeight: 1.7, maxWidth: '620px', marginBottom: '48px' }}>
              Карточка в Яндекс.Картах и сайт клиники работают в связке. Карточка приводит человека, сайт его убеждает.
            </p>
          </Reveal>
            ...
            <Reveal delay={0.1} fullHeight>
              <div className="dp-card" style={{ height: '100%', borderColor: 'rgba(6,182,212,0.3)', display: 'flex', flexDirection: 'column' }}>
                <div style={{
                  ...
                  <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '11px', color: '#06B6D4', letterSpacing: '0.06em' }}>САЙТ КЛИНИКИ</span>
                </div>
                <h3 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 'clamp(18px, 2.5vw, 22px)', fontWeight: 700, color: '#FFFFFF', margin: '0 0 8px' }}>
                  Сайт клиники на Tilda
                </h3>
            ...
            {[
              {
                ...
                desc: 'Системная работа над ростом позиций по запросам "стоматология серпухов" и связанным',
                price: '25 000 ₽/мес',
              },
              {
                icon: '✨',
                title: 'Дизайнерский сайт на коде',
                desc: 'С анимациями, индивидуальным дизайном. Для премиум-клиник, желающих выделиться',
                price: '50 000 ₽',
                old: '73 000 ₽',
              },
              {
        ...
        <div className="dp-container" style={{ textAlign: 'center' }}>
          <Reveal>
            ...
            <h2 className="dp-h2" style={{ maxWidth: '720px', margin: '0 auto 20px' }}>
              Составим план работ для вашей клиники за{' '}
              <span style={{
                background: 'linear-gradient(135deg, #6366F1, #06B6D4)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
              }}>15 минут</span>
            ...
            <div style={{
              ...
              {formSent ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  {[
                    { name: 'name', placeholder: 'Название клиники' },
